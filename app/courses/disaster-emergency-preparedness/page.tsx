...
export default function DisasterEmergencyPreparedness() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-amber-600 to-amber-500 text-white py-12 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <Link 
                    href="/contact"
                    className="block w-full bg-white text-amber-600 hover:bg-amber-100 py-3 rounded-xl font-semibold text-lg transition-colors mb-4 text-center"
                  >
                    Enquire Now
                  </Link>
