      ...
      <div className="relative bg-gradient-to-r from-cyan-600 to-cyan-500 text-white py-12 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="mb-6">
              <Link href="/courses/first-aid" className="text-cyan-200 hover:text-white flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                <p className="text-xl text-cyan-100 mb-6">
                  Refresh and update your first aid skills and certification
                </p>
              </div>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <div className="mb-6">
                    <p className="text-cyan-200 text-sm">Duration: {course.duration}</p>
                  </div>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {course.content.map((item, index) => (
                      <div key={index} className="flex items-start gap-3 bg-white p-4 rounded-xl shadow-sm border border-cyan-100">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="space-y-4">
                    <Link 
                      ...
                      className="block p-4 rounded-xl hover:bg-cyan-50 transition-colors"
                    >
