...
export default function EditTestimonialPage() {
  ...
  // Fetch testimonial data and trainings on mount
  useEffect(() => {
    Promise.all([
      fetchTestimonial(),
      fetchTrainings()
  ...
  const fetchTestimonial = async () => {
    try {
      ...
      // Get training ID and name
      let trainingId = ''
      let trainingName = ''
      if (typeof testimonial.trainingId === 'object' && testimonial.trainingId !== null) {
        trainingId = testimonial.trainingId._id
        trainingName = testimonial.trainingId.title
      } else if (typeof testimonial.trainingId === 'string') {
